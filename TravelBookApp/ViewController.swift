...
//  TravelBookApp
//
//  Created by aytug on 24.11.2020.
//
...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if selectedTitle != "" {
            ...
            fetchRequest.predicate = NSPredicate(format: "id = %@", selectedTitleID!.uuidString)
    ...
    @objc func chooseLocation(gestureRecognizer : UILongPressGestureRecognizer) {
        if gestureRecognizer.state == .began {
            ...
            choosedLatitude = touchedCoordinate.latitude
            choosedLongitude = touchedCoordinate.longitude
            let annotation = MKPointAnnotation()
    ...
    @IBAction func saveClicked(_ sender: Any) {
        ...
        newPalace.setValue(choosedLatitude, forKey: "latitude")
        newPalace.setValue(choosedLongitude, forKey: "longitude")
